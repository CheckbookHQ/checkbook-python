...
class Wallet:
    ...
    def _add_wallet_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/v3/account/wallet',
    ...
    def delete_wallet(
        self,
        wallet_id: Annotated[StrictStr, Field(description="The ID of the wallet to be deleted")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param wallet_id: The ID of the wallet to be deleted (required)
        :type wallet_id: str
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
    ...
    def _delete_wallet_serialize(
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/v3/account/wallet/{wallet_id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def update_wallet(
        self,
        wallet_id: Annotated[StrictStr, Field(description="The ID of the wallet to be updated")],
        ...
        :param wallet_id: The ID of the wallet to be updated (required)
        :type wallet_id: str
