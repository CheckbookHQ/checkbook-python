...
from checkbook.configuration import Configuration
from checkbook.api_response import ApiResponse, T as ApiResponseT
import checkbook.models
from checkbook import rest
from checkbook.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(checkbook.models, klass)
