...
class Number140416527981344(BaseModel):
    """
    Number140416527981344
    """ # noqa: E501
    account: Optional[StrictStr] = Field(default=None, description="Account number")
    routing: Optional[StrictStr] = Field(default=None, description="Routing number")
    __properties: ClassVar[List[str]] = ["account", "routing"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of Number140416527981344 from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of Number140416527981344 from a dict"""
        if obj is None:
            return None
