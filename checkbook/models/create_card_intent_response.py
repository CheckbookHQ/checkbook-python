...
class CreateCardIntentResponse(BaseModel):
    """
    CreateCardIntentResponse
    """ # noqa: E501
    token: Optional[StrictStr] = Field(default=None, description="Card token")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CreateCardIntentResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CreateCardIntentResponse from a dict"""
        if obj is None:
            return None
