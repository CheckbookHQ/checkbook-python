...
class CreateUserRequest(BaseModel):
    """
    Response fields for account listing
    """ # noqa: E501
    name: Annotated[str, Field(min_length=2, strict=True, max_length=180)] = Field(description="Name of user")
    user_id: Annotated[str, Field(min_length=2, strict=True, max_length=80)] = Field(description="Unique identifier for new user")
