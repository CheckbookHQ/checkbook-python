...
class GetBanksResponse(BaseModel):
    ...
    GetBanksResponse
    """ # noqa: E501
    banks: List[Bank] = Field(description="List of bank accounts for user")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GetBanksResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GetBanksResponse from a dict"""
        if obj is None:
            return None
