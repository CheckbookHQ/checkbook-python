...
class BankReleaseRequest(BaseModel):
    """
    BankReleaseRequest
    """ # noqa: E501
    account: StrictStr = Field(description="ID of the bank account")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of BankReleaseRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of BankReleaseRequest from a dict"""
        if obj is None:
            return None
