...
class CreateCardRequest(BaseModel):
    ...
    CreateCardRequest
    """ # noqa: E501
    address: Optional[CardAddress] = None
    card_number: StrictStr = Field(description="Card number")
    cvv: Optional[StrictStr] = Field(default=None, description="CVV code")
    expiration_date: StrictStr = Field(description="Expiration date (yyyy-mm)")
    __properties: ClassVar[List[str]] = ["address", "card_number", "cvv", "expiration_date"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "address": CardAddress.from_dict(obj["address"]) if obj.get("address") is not None else None,
