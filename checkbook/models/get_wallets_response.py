...
class GetWalletsResponse(BaseModel):
    ...
    GetWalletsResponse
    """ # noqa: E501
    wallets: List[Wallet] = Field(description="List of wallets for user")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GetWalletsResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GetWalletsResponse from a dict"""
        if obj is None:
            return None
