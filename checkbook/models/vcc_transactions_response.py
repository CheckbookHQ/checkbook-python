...
class VccTransactionsResponse(BaseModel):
    """
    ...
    total: Optional[StrictInt] = Field(default=None, description="Total number of transactions")
    transactions: List[VccTransaction] = Field(description="Transactions list")
    __properties: ClassVar[List[str]] = ["page", "pages", "total", "transactions"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of VccTransactionsResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of VccTransactionsResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "pages": obj.get("pages"),
            "total": obj.get("total"),
            "transactions": [VccTransaction.from_dict(_item) for _item in obj["transactions"]] if obj.get("transactions") is not None else None
        })
        return _obj
