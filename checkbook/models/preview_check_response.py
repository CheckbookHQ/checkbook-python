...
class PreviewCheckResponse(BaseModel):
    ...
    """ # noqa: E501
    image: StrictStr = Field(description="Base64 encoded check image")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PreviewCheckResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PreviewCheckResponse from a dict"""
        if obj is None:
            return None
