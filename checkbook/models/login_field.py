...
class LoginField(BaseModel):
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in set(['TEXT', 'PASSWORD', 'OPTION']):
            raise ValueError("must be one of enum values ('TEXT', 'PASSWORD', 'OPTION')")
        return value
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of LoginField from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of LoginField from a dict"""
        if obj is None:
            return None
