...
class IAVPlaidRequest(BaseModel):
    """
    IAVPlaidRequest
    """ # noqa: E501
    processor_token: StrictStr = Field(description="Plaid processor token")
    __properties: ClassVar[List[str]] = ["processor_token"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IAVPlaidRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IAVPlaidRequest from a dict"""
        if obj is None:
            return None
