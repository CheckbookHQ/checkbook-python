...
class MerchantResponseAddress(BaseModel):
    """
    Address field
    """ # noqa: E501
    ...
    line_1: Optional[StrictStr] = Field(default=None, description="Street line 1")
    line_2: Optional[StrictStr] = Field(default=None, description="Street line 2")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of MerchantResponseAddress from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of MerchantResponseAddress from a dict"""
        if obj is None:
            return None
