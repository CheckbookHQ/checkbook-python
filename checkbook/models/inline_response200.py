...
class InlineResponse200(BaseModel):
    ...
    InlineResponse200
    """ # noqa: E501
    wallets: Optional[List[CreateWalletResponse]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "wallets": [CreateWalletResponse.from_dict(_item) for _item in obj["wallets"]] if obj.get("wallets") is not None else None
        })
        return _obj
