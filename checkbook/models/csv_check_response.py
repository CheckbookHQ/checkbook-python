...
class CsvCheckResponse(BaseModel):
    """
    CsvCheckResponse
    """ # noqa: E501
    checks: List[GetCheckResponse] = Field(description="List of created checks")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CsvCheckResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CsvCheckResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "checks": [GetCheckResponse.from_dict(_item) for _item in obj["checks"]] if obj.get("checks") is not None else None
        })
        return _obj
