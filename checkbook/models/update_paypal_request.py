...
class UpdatePaypalRequest(BaseModel):
    """
    UpdatePaypalRequest
    """ # noqa: E501
    name: Optional[Annotated[str, Field(strict=True, max_length=128)]] = Field(default=None, description="Name for the PayPal account")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of UpdatePaypalRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of UpdatePaypalRequest from a dict"""
        if obj is None:
            return None
