...
class MfaSelectionField(BaseModel):
    """
    MfaSelectionField
    """ # noqa: E501
    description: Optional[StrictStr] = Field(default=None, description="MFA field description")
    name: Optional[StrictStr] = Field(default=None, description="MFA field name")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of MfaSelectionField from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of MfaSelectionField from a dict"""
        if obj is None:
            return None
