...
class Color(BaseModel):
    ...
    Payment fields
    """ # noqa: E501
    primary: Optional[StrictStr] = Field(default=None, description="Payment expiration")
    secondary: Optional[StrictStr] = Field(default=None, description="Payment expiration")
