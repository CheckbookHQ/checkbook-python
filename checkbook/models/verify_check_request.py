...
class VerifyCheckRequest(BaseModel):
    ...
    VerifyCheckRequest
    """ # noqa: E501
    code: StrictStr = Field(description="Verification code")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of VerifyCheckRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of VerifyCheckRequest from a dict"""
        if obj is None:
            return None
