...
class MFAOption(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["name", "response", "type"]
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in set(['IMAGE', 'SELECTION', 'TEXT']):
            raise ValueError("must be one of enum values ('IMAGE', 'SELECTION', 'TEXT')")
        return value
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of MFAOption from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of MFAOption from a dict"""
        if obj is None:
            return None
