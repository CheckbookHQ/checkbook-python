...
class VerifyCheckResponse(BaseModel):
    ...
    VerifyCheckResponse
    """ # noqa: E501
    success: Optional[StrictBool] = Field(default=None, description="Success indicator")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of VerifyCheckResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of VerifyCheckResponse from a dict"""
        if obj is None:
            return None
