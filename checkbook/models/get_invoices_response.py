...
class GetInvoicesResponse(BaseModel):
    ...
    GetInvoicesResponse
    """ # noqa: E501
    invoices: List[GetInvoiceResponse] = Field(description="List of sent/received invoices")
    page: StrictInt
    pages: StrictInt
    total: StrictInt
    __properties: ClassVar[List[str]] = ["invoices", "page", "pages", "total"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "invoices": [GetInvoiceResponse.from_dict(_item) for _item in obj["invoices"]] if obj.get("invoices") is not None else None,
            "page": obj.get("page"),
            "pages": obj.get("pages"),
            "total": obj.get("total")
        })
