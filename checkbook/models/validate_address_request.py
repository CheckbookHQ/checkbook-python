...
class ValidateAddressRequest(BaseModel):
    """
    Request fields for validating a list of physical addresses
    """ # noqa: E501
    address_list: List[Annotated[str, Field(min_length=2, strict=True, max_length=250)]]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "address_list": obj.get("address_list")
        })
        return _obj
