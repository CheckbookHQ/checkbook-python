...
class VerifyUserRequest(BaseModel):
    ...
    type: StrictStr = Field(description="Verification type")
    __properties: ClassVar[List[str]] = ["phone", "type"]

    @field_validator('type')
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['call', 'sms', 'email', 'tfa']):
            raise ValueError("must be one of enum values ('call', 'sms', 'email', 'tfa')")
        return value
