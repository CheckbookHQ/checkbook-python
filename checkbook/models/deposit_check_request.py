...
class DepositCheckRequest(BaseModel):
    ...
    DepositCheckRequest
    """ # noqa: E501
    account: StrictStr = Field(description="ID of the account to deposit the payment")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DepositCheckRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DepositCheckRequest from a dict"""
        if obj is None:
            return None
