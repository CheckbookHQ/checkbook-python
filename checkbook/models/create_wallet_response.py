...
class CreateWalletResponse(BaseModel):
    ...
    numbers: Optional[Numbers140416527982288] = None
    __properties: ClassVar[List[str]] = ["date", "id", "name", "numbers"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "id": obj.get("id"),
            "name": obj.get("name"),
            "numbers": Numbers140416527982288.from_dict(obj["numbers"]) if obj.get("numbers") is not None else None
        })
        return _obj
