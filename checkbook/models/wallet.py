...
class Wallet(BaseModel):
    ...
    Wallet
    """ # noqa: E501
    balance: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Indicates the current amount left in the wallet's balance")
    ...
    name: Optional[StrictStr] = Field(default=None, description="Name of the wallet")
    numbers: Optional[Numbers] = None
    __properties: ClassVar[List[str]] = ["balance", "date", "id", "name", "numbers"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "id": obj.get("id"),
            "name": obj.get("name"),
            "numbers": Numbers.from_dict(obj["numbers"]) if obj.get("numbers") is not None else None
        })
        return _obj
