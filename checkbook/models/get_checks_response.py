...
class GetChecksResponse(BaseModel):
    """
    GetChecksResponse
    """ # noqa: E501
    checks: List[Check] = Field(description="List of sent/received payments")
    page: StrictInt
    pages: StrictInt
    total: StrictInt
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GetChecksResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GetChecksResponse from a dict"""
        if obj is None:
            return None
