...
class Developer(BaseModel):
    ...
    Developer fields
    """ # noqa: E501
    webhook_uri: Optional[Annotated[str, Field(strict=True, max_length=256)]] = Field(default=None, description="Webhook URI")
    __properties: ClassVar[List[str]] = ["webhook_uri"]
