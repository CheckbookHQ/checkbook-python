...
class UpdateCardRequest(BaseModel):
    ...
    UpdateCardRequest
    """ # noqa: E501
    default: Optional[StrictBool] = Field(default=None, description="Indicates the default card")
    name: Optional[Annotated[str, Field(strict=True, max_length=128)]] = Field(default=None, description="Name of the card")
