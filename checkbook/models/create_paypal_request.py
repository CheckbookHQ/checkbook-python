...
class CreatePaypalRequest(BaseModel):
    """
    CreatePaypalRequest
    """ # noqa: E501
    username: Annotated[str, Field(strict=True, max_length=128)] = Field(description="PayPal email or phone number")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CreatePaypalRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CreatePaypalRequest from a dict"""
        if obj is None:
            return None
