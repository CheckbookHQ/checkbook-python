...
class VccAddress(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["city", "country", "line_1", "state", "zip"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of VccAddress from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of VccAddress from a dict"""
        if obj is None:
            return None
