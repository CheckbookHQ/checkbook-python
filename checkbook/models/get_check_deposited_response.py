...
class GetCheckDepositedResponse(BaseModel):
    """
    GetCheckDepositedResponse
    """ # noqa: E501
    check_type: Optional[StrictStr] = Field(description="Check type")
    eta: Optional[date]
    recipient: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["check_type", "eta", "recipient"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GetCheckDepositedResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GetCheckDepositedResponse from a dict"""
        if obj is None:
            return None
