...
class EndorseCheckRequest(BaseModel):
    """
    EndorseCheckRequest
    """ # noqa: E501
    name: Annotated[str, Field(min_length=2, strict=True, max_length=255)] = Field(description="Name of the endorser")
    signature: Optional[StrictStr] = Field(default=None, description="Signature of the endorser")
    __properties: ClassVar[List[str]] = ["name", "signature"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of EndorseCheckRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of EndorseCheckRequest from a dict"""
        if obj is None:
            return None
