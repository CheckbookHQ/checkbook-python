...
class APIKeyListResponse(BaseModel):
    ...
    """ # noqa: E501
    api_keys: List[GetApiKeyResponse] = Field(description="List of API keys")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "api_keys": [GetApiKeyResponse.from_dict(_item) for _item in obj["api_keys"]] if obj.get("api_keys") is not None else None
        })
        return _obj
