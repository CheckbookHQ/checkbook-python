...
class GetMailboxesResponse(BaseModel):
    """
    GetMailboxesResponse
    """ # noqa: E501
    mailboxes: List[CreateMailboxResponse] = Field(description="List of sent/received payments")
    page: StrictInt
    pages: StrictInt
    total: StrictInt
    __properties: ClassVar[List[str]] = ["mailboxes", "page", "pages", "total"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GetMailboxesResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GetMailboxesResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "mailboxes": [CreateMailboxResponse.from_dict(_item) for _item in obj["mailboxes"]] if obj.get("mailboxes") is not None else None,
            "page": obj.get("page"),
            "pages": obj.get("pages"),
            "total": obj.get("total")
        })
