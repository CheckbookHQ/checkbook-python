...
class IAVPlaidResponse(BaseModel):
    """
    IAVPlaidResponse
    """ # noqa: E501
    accounts: Optional[List[PlaidAccount]] = Field(default=None, description="List of valid bank accounts")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IAVPlaidResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IAVPlaidResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "accounts": [PlaidAccount.from_dict(_item) for _item in obj["accounts"]] if obj.get("accounts") is not None else None
        })
        return _obj
