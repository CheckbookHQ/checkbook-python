...
class BrandResponse(BaseModel):
    ...
    reply_to: Optional[StrictStr] = Field(default=None, description="Email reply to address")
    slogan: Optional[StrictStr] = Field(default=None, description="Email slogan")
    __properties: ClassVar[List[str]] = ["footer", "logo", "reply_to", "slogan"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of BrandResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of BrandResponse from a dict"""
        if obj is None:
            return None
