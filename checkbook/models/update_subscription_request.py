...
class UpdateSubscriptionRequest(BaseModel):
    ...
    skipped: Optional[List[StrictInt]] = Field(default=None, description="List of skipped subscription indexes (e.g. [1] indicates the first subscription will be skipped)")
    __properties: ClassVar[List[str]] = ["autopay", "skipped"]
