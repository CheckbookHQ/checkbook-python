...
class GetCheckbookTrackingResponseExpress(BaseModel):
    """
    GetCheckbookTrackingResponseExpress
    """ # noqa: E501
    tracking: List[TrackingNumber] = Field(description="Tracking number")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GetCheckbookTrackingResponseExpress from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GetCheckbookTrackingResponseExpress from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "tracking": [TrackingNumber.from_dict(_item) for _item in obj["tracking"]] if obj.get("tracking") is not None else None
        })
        return _obj
