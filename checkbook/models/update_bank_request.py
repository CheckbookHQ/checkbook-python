...
class UpdateBankRequest(BaseModel):
    ...
    UpdateBankRequest
    """ # noqa: E501
    billing: Optional[StrictBool] = Field(default=None, description="Specification of billing account")
    default: Optional[StrictBool] = Field(default=None, description="Specification of default account")
    name: Optional[Annotated[str, Field(strict=True, max_length=128)]] = Field(default=None, description="Name for account")
    __properties: ClassVar[List[str]] = ["billing", "default", "name"]
