...
class GetCheckFailedResponse(BaseModel):
    """
    GetCheckFailedResponse
    """ # noqa: E501
    code: Optional[StrictStr] = Field(description="Check fail code")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GetCheckFailedResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GetCheckFailedResponse from a dict"""
        if obj is None:
            return None
