...
class GetInteracResponse(BaseModel):
    """
    GetInteracResponse
    """ # noqa: E501
    accounts: List[InteracAccountResponse] = Field(description="List of Interac accounts")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GetInteracResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GetInteracResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "accounts": [InteracAccountResponse.from_dict(_item) for _item in obj["accounts"]] if obj.get("accounts") is not None else None
        })
        return _obj
