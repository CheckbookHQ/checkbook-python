...
class DirectoryAddress(BaseModel):
    """
    DirectoryAddress
    """ # noqa: E501
    ...
    line_1: Optional[StrictStr] = Field(default=None, description="Line 1")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DirectoryAddress from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DirectoryAddress from a dict"""
        if obj is None:
            return None
