...
class CreateUserResponse(BaseModel):
    ...
    user_id: Optional[StrictStr] = Field(default=None, description="Specific user_id provided by the marketplace owner")
    __properties: ClassVar[List[str]] = ["id", "key", "secret", "user_id"]
