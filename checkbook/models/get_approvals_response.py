...
class GetApprovalsResponse(BaseModel):
    """
    GetApprovalsResponse
    """ # noqa: E501
    checks: List[Approval] = Field(description="List of sent/received payment")
    page: StrictInt
    pages: StrictInt
    total: StrictInt
    __properties: ClassVar[List[str]] = ["checks", "page", "pages", "total"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GetApprovalsResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GetApprovalsResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "checks": [Approval.from_dict(_item) for _item in obj["checks"]] if obj.get("checks") is not None else None,
            "page": obj.get("page"),
            "pages": obj.get("pages"),
            "total": obj.get("total")
        })
