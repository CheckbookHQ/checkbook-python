...
class BankSettings(BaseModel):
    ...
    Bank fields
    """ # noqa: E501
    billing: Optional[StrictStr] = Field(default=None, description="Billing bank account id (if user has multiple bank accounts)")
    default: Optional[StrictStr] = Field(default=None, description="Default bank account id (if user has multiple bank accounts)")
    __properties: ClassVar[List[str]] = ["billing", "default"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of BankSettings from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of BankSettings from a dict"""
        if obj is None:
            return None
