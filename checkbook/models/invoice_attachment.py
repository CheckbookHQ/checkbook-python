...
class InvoiceAttachment(BaseModel):
    ...
    InvoiceAttachment
    """ # noqa: E501
    content: StrictStr = Field(description="Attachment content")
    filename: Annotated[str, Field(min_length=1, strict=True, max_length=128)] = Field(description="Attachment filename")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of InvoiceAttachment from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of InvoiceAttachment from a dict"""
        if obj is None:
            return None
