...
class CreateVenmoRequest(BaseModel):
    """
    CreateVenmoRequest
    """ # noqa: E501
    username: Annotated[str, Field(strict=True, max_length=128)] = Field(description="Venmo email or phone number")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CreateVenmoRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CreateVenmoRequest from a dict"""
        if obj is None:
            return None
