...
class CreateVccRequest(BaseModel):
    """
    CreateVccRequest
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["address", "email", "phone"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CreateVccRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CreateVccRequest from a dict"""
        if obj is None:
            return None
