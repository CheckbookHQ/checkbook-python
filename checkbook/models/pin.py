...
class Pin(BaseModel):
    ...
    Pin
    """ # noqa: E501
    description: Annotated[str, Field(strict=True, max_length=64)] = Field(description="PIN description")
    value: Annotated[str, Field(strict=True, max_length=15)] = Field(description="Expected PIN value")
