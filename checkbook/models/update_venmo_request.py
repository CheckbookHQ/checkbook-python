...
class UpdateVenmoRequest(BaseModel):
    """
    UpdateVenmoRequest
    """ # noqa: E501
    name: Optional[Annotated[str, Field(strict=True, max_length=128)]] = Field(default=None, description="Name for the Venmo account")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of UpdateVenmoRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of UpdateVenmoRequest from a dict"""
        if obj is None:
            return None
