...
class ValidateAddressResponse(BaseModel):
    """
    Response fields for validating a list of physical addresses
    """ # noqa: E501
    address_list: List[AddressResponse]
    __properties: ClassVar[List[str]] = ["address_list"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "address_list": [AddressResponse.from_dict(_item) for _item in obj["address_list"]] if obj.get("address_list") is not None else None
        })
        return _obj
