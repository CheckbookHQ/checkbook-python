...
class UpdateInteracRequest(BaseModel):
    """
    UpdateInteracRequest
    """ # noqa: E501
    name: Optional[Annotated[str, Field(strict=True, max_length=128)]] = Field(default=None, description="Name for the Interac account")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of UpdateInteracRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of UpdateInteracRequest from a dict"""
        if obj is None:
            return None
