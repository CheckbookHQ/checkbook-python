...
[**GetApprovalResponse**](GetApprovalResponse.md)
...
[**GetApprovalsResponse**](GetApprovalsResponse.md)
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **release_check_request** | [**ReleaseCheckRequest**](ReleaseCheckRequest.md)|  | 
...
------------- | ------------- | ------------- | -------------
 **approval_id** | **str**|  | 
 **update_approval_request** | [**UpdateApprovalRequest**](UpdateApprovalRequest.md)|  | 
